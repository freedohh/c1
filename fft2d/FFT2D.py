...
# 20210622
# Copy this script to C:\Program Files\AnsysEM\AnsysEM_._\Win64\syslib\UserDefinedOutputs 
##############################################################
import os, sys,clr
...
class UDOExtension(BaseExampleUDOClass):
    ...
    def Compute(self, inData, outData, params, progMon):
        ...
        Order1 = params.GetNumberProperty(self._kInputs[0][0]).ValueSI  # 时间和空间阶次
        ...
        if export == 'Yes':
            ...
            path = oDesign.GetManagedFilesPath()
